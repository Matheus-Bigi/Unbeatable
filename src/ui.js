...
const HAND_IMAGES = {
  rock: "assets/hands/rock.webp?v=14",
  paper: "assets/hands/paper.webp?v=14",
  scissors: "assets/hands/scissors.webp?v=14",
};
const NEUTRAL_HAND_IMAGE = "assets/hands/neutral.webp?v=14";
