...
const HAND_IMAGES = {
  rock: "assets/hands/rock.webp?v=11",
  paper: "assets/hands/paper.webp?v=11",
  scissors: "assets/hands/scissors.webp?v=11",
};
const NEUTRAL_HAND_IMAGE = "assets/hands/neutral.webp?v=11";
