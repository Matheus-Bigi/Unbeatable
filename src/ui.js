...
const HAND_IMAGES = {
  rock: "assets/hands/rock.webp?v=15",
  paper: "assets/hands/paper.webp?v=15",
  scissors: "assets/hands/scissors.webp?v=15",
};
const NEUTRAL_HAND_IMAGE = "assets/hands/neutral.webp?v=15";
